...
class ClienteModel(AbstractBaseUser, PermissionsMixin):
    ...
    TIPO_CLIENTE = [(1,'ADMINISTRADOR'),(2,'COLABORADOR'),(3,'CLIENTE')]
    ...
    REQUIRED_FIELDS = ['clienteNombre','clienteApellido','clienteDocumento','clienteCelular','clienteTipo']
