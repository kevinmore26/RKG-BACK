    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clientes', models.ForeignKey(db_column='cliente_id', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='clienteAdopcion', to='gestion.clientemodel')),
            ],
            options={
