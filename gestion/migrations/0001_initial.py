# Generated by Django 3.2.7 on 2021-10-09 05:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('metodoPagoId', models.AutoField(db_column='id', primary_key=True, serialize=False, unique=True)),
                ('metodoTipo', models.TextField(choices=[('T', 'TARJETA'), ('CE', 'CONTRAENTREGA')], db_column='metodo', default='T')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productoUnidadMedida', models.TextField(choices=[('UN', 'UNIDAD')], db_column='unidad_medida', default='UN', verbose_name='UnidadMedida')),
                ('productoDescripcion', models.CharField(db_column='descripcion', default='none', max_length=100, verbose_name='descripcion')),
                ...
                ('productoFoto', models.ImageField(db_column='foto', null=True, upload_to='platos/')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metodoPago', models.ForeignKey(db_column='metodo_id', on_delete=django.db.models.deletion.PROTECT, related_name='ordenMetodo', to='gestion.metodopagomodel')),
